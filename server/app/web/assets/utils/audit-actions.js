...
export const AUDIT_ACTIONS = {
  ...
  file_upload:     { label: '上传文件', cls: 'ok',   category: 'file' },
  file_note:       { label: '保存笔记', cls: 'ok',   category: 'file' },
  note_ai_tags:    { label: 'AI 整理标签', cls: 'warn', category: 'file' },
  file_preview:    { label: '预览文件', cls: 'ok',   category: 'file' },
  trash_preview:   { label: '预览回收站文件', cls: 'ok', category: 'file' },
  file_download:   { label: '下载文件', cls: 'warn', category: 'file' },
  file_export:     { label: '导出文件', cls: 'warn', category: 'file' },
  file_rename:     { label: '重命名文件', cls: 'warn', category: 'file' },
  file_pin:        { label: '置顶文件', cls: 'warn', category: 'file' },
  file_unpin:      { label: '取消置顶', cls: 'warn', category: 'file' },
  file_lock:       { label: '锁存文件', cls: 'warn', category: 'file' },
  file_unlock:     { label: '解锁文件', cls: 'warn', category: 'file' },
  file_restore:    { label: '恢复文件', cls: 'ok',   category: 'file' },
  file_batch_restore: { label: '批量恢复', cls: 'ok', category: 'file' },
  file_soft_delete:   { label: '删除文件', cls: 'fail', category: 'file' },
  file_purge:      { label: '彻底删除', cls: 'fail', category: 'file' },
  file_batch_purge:   { label: '批量彻底删除', cls: 'fail', category: 'file' },
  file_trash_empty:   { label: '清空回收站', cls: 'fail', category: 'file' },
  transfer_text:   { label: '传输文字', cls: 'ok',   category: 'file' },
  transfer_file:   { label: '传输文件', cls: 'ok',   category: 'file' },
  transfer_delete: { label: '删除传输记录', cls: 'fail', category: 'file' },
